<script>
 ...
 onMount(() =>{
  ...
  if ($cartTotal > 0) {
     stripe = Stripe("pk_test_51KxXrIEVYyKNkSPlVShk5044pPzPVANkyzcJludCpy8ZAupVEx5xdYRdeX9g8G6gIFJSYotQ1ncM6LWR5c0mpyE900iF9HqrEm");
 ...
 async function handleSubmit() {
  ...
  if (token) {
   ...
   if (order) {
    ...
    globalStore.toggleItem('alert', true, 'There was an error wit your order. Please try again', true)
   }
 }
 }
</script>
 ...
 <form action="" class="checkout-form" on:submit|preventDefault={handleSubmit}>
  ...
  <div class="stripe-input">
   ...
   <p class="stripe-info">
    ...
    <br>
    enter any 5 digits for the zipcode
    <br>
